...
export default function AdminNewsletters() {
  ...
  function onSubmit(data: NewsletterFormValues) {
    ...
    if (normalizedData.imageUrl && !normalizedData.imageUrl.startsWith('/') && !normalizedData.imageUrl.startsWith('http')) {
      normalizedData.imageUrl = '/' + normalizedData.imageUrl;
    }

    if (editingId) {
      updateNewsletter.mutate({ id: editingId, ...normalizedData });
    } else {
      createNewsletter.mutate({ ...normalizedData, published: false });
    }
  }
